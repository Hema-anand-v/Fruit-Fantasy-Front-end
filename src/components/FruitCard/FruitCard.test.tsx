...
// const apple: Fruit = { id: 1, name: 'Apple', image: 'apple.jpg', price: 100, unit: 'kg' };
// const mango: Fruit = { id: 2, name: 'Mango', image: 'mango.jpg', price: 120, discount: 20, unit: 'kg' };

// //demo 4

// describe('FruitCard', () => {
//   test('renders alt text from name and no discount badge when discount=0', () => {
//     render(<FruitCard fruit={apple} role='admin'/>);
